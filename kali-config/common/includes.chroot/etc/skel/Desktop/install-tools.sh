...
cd ~/Desktop
wget -O Obsidian-1.3.7-arm64.AppImage https://github.com/obsidianmd/obsidian-releases/releases/download/v1.3.7/Obsidian-1.3.7-arm64.AppImage 
chmod +x Obsidian-1.3.7-arm64.AppImage
